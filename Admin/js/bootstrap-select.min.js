...
!function(e, t) {
    ...
    !function(T) {
        ...
        var d = ["sanitize", "whiteList", "sanitizeFn"]
          ...
          , e = {
            "*": ["class", "dir", "id", "lang", "role", "tabindex", "style", /^aria-[\w-]*Rs./i],
          ...
          , r = /^(?:(?:https?|mailto|ftp|tel|file):|[^&:/?#]*(?:[/?#]|Rs.))/gi
          , a = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*Rs./i
          , n = ["title", "placeholder"];
        function v(e, t) {
        ...
        function X(e, t) {
            ...
            this.Rs.menuInner[0].firstChild.appendChild(K.noResults))
        }
        function ee(e) {
        ...
        function ie(e) {
            ...
            !j.success) {
                try {
                    ...
                    console.warn("There was an issue retrieving Bootstrap's version. Ensure Bootstrap is being loaded before bootstrap-select and there is no namespace collision. If loading Bootstrap asynchronously, the version may need to be manually specified via Rs..fn.selectpicker.Constructor.BootstrapVersion.", e))
                }
                j.major = j.full[0],
                j.success = !0
            }
        ...
        te.prototype = {
            ...
            init: function() {
                var i = this
                  , e = this.Rs.element.attr("id")
                  , t = this.Rs.element[0]
                  , s = t.form;
                _++,
                this.selectId = "bs-select-" + _,
                t.classList.add("bs-select-hidden"),
                this.multiple = this.Rs.element.prop("multiple"),
                this.autofocus = this.Rs.element.prop("autofocus"),
                t.classList.contains("show-tick") && (this.options.showTick = !0),
                this.Rs.newElement = this.createDropdown(),
                this.Rs.element.after(this.Rs.newElement).prependTo(this.Rs.newElement),
                s && null === t.form && (s.id || (s.id = "form-" + this.selectId),
                t.setAttribute("form", s.id)),
                this.Rs.button = this.Rs.newElement.children("button"),
                this.options.allowClear && (this.Rs.clearButton = this.Rs.button.children(".bs-select-clear-selected")),
                this.Rs.menu = this.Rs.newElement.children(q.MENU),
                this.Rs.menuInner = this.Rs.menu.children(".inner"),
                this.Rs.searchbox = this.Rs.menu.find("input"),
                t.classList.remove("bs-select-hidden"),
                this.fetchData(function() {
                    i.render(!0),
                    i.buildList(),
                    requestAnimationFrame(function() {
                        i.Rs.element.trigger("loaded" + F)
                    })
                }),
                this.fetchData(function() {
                    i.render(!0),
                ...
                !0 === this.options.dropdownAlignRight && this.Rs.menu[0].classList.add(G.MENURIGHT),
                void 0 !== e && this.Rs.button.attr("data-id", e),
                this.checkDisabled(),
                this.clickListener(),
                4 < j.major && (this.dropdown = new U(this.Rs.button[0])),
                this.options.liveSearch ? (this.liveSearchListener(),
                this.focusedParent = this.Rs.searchbox[0]) : this.focusedParent = this.Rs.menuInner[0],
                this.setStyle(),
                this.setWidth(),
                this.options.container ? this.selectPosition() : this.Rs.element.on("hide" + F, function() {
                    if (i.isVirtual()) {
                        var e = i.Rs.menuInner[0]
                          , t = e.firstChild.cloneNode(!1);
                        e.replaceChild(t, e.firstChild),
                        e.scrollTop = 0
                    }
                }),
                this.Rs.menu.data("this", this),
                this.Rs.newElement.data("this", this),
                this.options.mobile && this.mobile(),
                this.Rs.newElement.on({
                    "hide.bs.dropdown": function(e) {
                        i.Rs.element.trigger("hide" + F, e)
                    },
                    "hidden.bs.dropdown": function(e) {
                        i.Rs.element.trigger("hidden" + F, e)
                    },
                    "show.bs.dropdown": function(e) {
                        i.Rs.element.trigger("show" + F, e)
                    },
                    "shown.bs.dropdown": function(e) {
                        i.Rs.element.trigger("shown" + F, e)
                    }
                }),
                t.hasAttribute("required") && this.Rs.element.on("invalid" + F, function() {
                    i.Rs.button[0].classList.add("bs-invalid"),
                    i.Rs.element.on("shown" + F + ".invalid", function() {
                        i.Rs.element.val(i.Rs.element.val()).off("shown" + F + ".invalid")
                    }).on("rendered" + F, function() {
                        this.validity.valid && i.Rs.button[0].classList.remove("bs-invalid"),
                        i.Rs.element.off("rendered" + F)
                    }),
                    i.Rs.button.on("blur" + F, function() {
                        i.Rs.element.trigger("focus").trigger("blur"),
                        i.Rs.button.off("blur" + F)
                    })
                }),
            ...
            createDropdown: function() {
                ...
                j.major < 4 && this.Rs.element.parent().hasClass("input-group") && (i = " input-group-btn");
                var n, o = "", l = "", r = "", a = "", c = "";
            ...
            createView: function(z, e, t) {
                ...
                e)
                    if (t)
                        i = this.Rs.menuInner[0].scrollTop;
                    else if (!N.multiple) {
                        var s = N.Rs.element[0]
                ...
                function W(e, t) {
                    ...
                    t || a) {
                        ...
                        (t || !0 === u) && p) {
                            var v, g, b = N.Rs.menuInner[0], w = document.createDocumentFragment(), I = b.firstChild.cloneNode(!1), x = N.selectpicker.view.visibleElements, k = [];
                            b.replaceChild(I, b.firstChild);
                            f = 0;
                            for (var y = x.length; f < y; f++) {
                                var Rs., S, E = x[f];
                                N.options.sanitize && (Rs. = E.lastChild) && (S = N.selectpicker.current.data[f + N.selectpicker.view.position0]) && S.content && !S.sanitized && (k.push(Rs.),
                                S.sanitized = !0),
                                w.appendChild(E)
                            }
                    ...
                    N.options.liveSearch) {
                        ...
                        N.Rs.menuInner.trigger("focus")
                }
                W(i, !0),
                this.Rs.menuInner.off("scroll.createView").on("scroll.createView", function(e, t) {
                ...
                T(window).off("resize" + F + "." + this.selectId + ".createView").on("resize" + F + "." + this.selectId + ".createView", function() {
                    N.Rs.newElement.hasClass(G.SHOW) && W(N.Rs.menuInner[0].scrollTop)
                })
            },
            ...
            setPlaceholder: function() {
                ...
                if ((this.options.placeholder || this.options.allowClear) && !this.multiple) {
                    ...
                    s = !l || o === a && !1 === l.defaultSelected && void 0 === this.Rs.element.data("selected")),
            ...
            buildData: function(p, e) {
                ...
                var t = p ? p.filter(ee, this) : this.Rs.element[0].querySelectorAll("select > *" + f);
                function b(e) {
                    var t = m[m.length - 1];
            ...
            findLis: function() {
                return this.Rs.menuInner.find(".inner > li")
            },
            render: function(e) {
                var t, i = this, s = this.Rs.element[0], n = this.setPlaceholder() && 0 === s.selectedIndex, o = A.call(this), l = o.length, r = z.call(this, o), a = this.Rs.button[0], c = a.querySelector(".filter-option-inner-inner"), d = document.createTextNode(this.options.multipleSeparator), h = K.fragment.cloneNode(!1), p = !1;
                ...
                "static" === this.options.selectedTextFormat)
                    ...
                    var g = this.Rs.element[0].querySelectorAll("select > option" + v + ", optgroup" + v + " option" + v).length
                ...
                c.innerHTML = "",
                c.appendChild(h),
                j.major < 4 && this.Rs.newElement[0].classList.contains("bs3-has-addon")) {
                    var w = a.querySelector(".filter-expand")
                      , I = c.cloneNode(!0);
                    I.className = "filter-expand",
                    w ? a.replaceChild(I, w) : a.appendChild(I)
                }
                this.Rs.element.trigger("rendered" + F)
            },
            setStyle: function(e, t) {
                var i, s = this.Rs.button[0], n = this.Rs.newElement[0], o = this.options.style.trim();
                this.Rs.element.attr("class") && this.Rs.newElement.addClass(this.Rs.element.attr("class").replace(/selectpicker|mobile-device|bs-select-hidden|validate\[.*\]/gi, "")),
            ...
            liHeight: function(e) {
                if (e || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                    var t, i = K.div.cloneNode(!1), s = K.div.cloneNode(!1), n = K.div.cloneNode(!1), o = document.createElement("ul"), l = K.li.cloneNode(!1), r = K.li.cloneNode(!1), a = K.a.cloneNode(!1), c = K.span.cloneNode(!1), d = this.options.header && 0 < this.Rs.menu.find("." + G.POPOVERHEADER).length ? this.Rs.menu.find("." + G.POPOVERHEADER)[0].cloneNode(!0) : null, h = this.options.liveSearch ? K.div.cloneNode(!1) : null, p = this.options.actionsBox && this.multiple && 0 < this.Rs.menu.find(".bs-actionsbox").length ? this.Rs.menu.find(".bs-actionsbox")[0].cloneNode(!0) : null, u = this.options.doneButton && this.multiple && 0 < this.Rs.menu.find(".bs-donebutton").length ? this.Rs.menu.find(".bs-donebutton")[0].cloneNode(!0) : null, f = this.Rs.element[0].options[0];
                    if (this.sizeInfo.selectWidth = this.Rs.newElement[0].offsetWidth,
                    c.className = "text",
                    a.className = "dropdown-item " + (f ? f.className : ""),
                    i.className = this.Rs.menu[0].parentNode.className + " " + G.SHOW,
                    i.style.width = 0,
                    ...
                    var b, w = t.offsetHeight, I = r ? r.offsetHeight : 0, x = d ? d.offsetHeight : 0, k = h ? h.offsetHeight : 0, y = p ? p.offsetHeight : 0, Rs. = u ? u.offsetHeight : 0, S = T(l).outerHeight(!0), E = window.getComputedStyle(s), C = s.offsetWidth, O = {
                    ...
                    this.sizeInfo.doneButtonHeight = Rs.,
                    ...
                    this.sizeInfo.selectHeight = this.Rs.newElement[0].offsetHeight,
                    this.setPositionData()
                }
            },
            getSelectPosition: function() {
                var e, t = T(window), i = this.Rs.newElement.offset(), s = T(this.options.container);
            ...
            setMenuSize: function(e) {
                ...
                this.Rs.newElement.toggleClass(G.DROPUP, a),
                ...
                "auto" === this.options.size)
                    ...
                    this.Rs.newElement.hasClass(G.DROPUP) && (i = this.sizeInfo.selectOffsetTop - this.sizeInfo.menuExtras.vert),
                ...
                "auto" === this.options.dropdownAlignRight && this.Rs.menu.toggleClass(G.MENURIGHT, this.sizeInfo.selectOffsetLeft > this.sizeInfo.selectOffsetRight && this.sizeInfo.selectOffsetRight < this.sizeInfo.totalMenuWidth - c),
                this.dropdown && this.dropdown._popper && this.dropdown._popper.update()
            },
            setSize: function(e) {
                if (this.liHeight(e),
                this.options.header && this.Rs.menu.css("padding-top", 0),
                !1 !== this.options.size) {
                    var t = this
                      , i = T(window);
                    this.setMenuSize(),
                    this.options.liveSearch && this.Rs.searchbox.off("input.setMenuSize propertychange.setMenuSize").on("input.setMenuSize propertychange.setMenuSize", function() {
            ...
            setWidth: function() {
                ...
                "auto" === this.options.width ? requestAnimationFrame(function() {
                    i.Rs.menu.css("min-width", "0"),
                    i.Rs.element.on("loaded" + F, function() {
                        i.liHeight(),
                        i.setMenuSize();
                        var e = i.Rs.newElement.clone().appendTo("body")
                          , t = e.css("width", "auto").children("button").outerWidth();
                        e.remove(),
                        i.sizeInfo.selectWidth = Math.max(i.sizeInfo.totalMenuWidth, t),
                        i.Rs.newElement.css("width", i.sizeInfo.selectWidth + "px")
                    })
                }) : "fit" === this.options.width ? (this.Rs.menu.css("min-width", ""),
                this.Rs.newElement.css("width", "").addClass("fit-width")) : this.options.width ? (this.Rs.menu.css("min-width", ""),
                this.Rs.newElement.css("width", this.options.width)) : (this.Rs.menu.css("min-width", ""),
                this.Rs.newElement.css("width", "")),
                this.Rs.newElement.hasClass("fit-width") && "fit" !== this.options.width && this.Rs.newElement[0].classList.remove("fit-width")
            },
            selectPosition: function() {
                this.Rs.bsContainer = T('<div class="bs-container" />');
                function e(e) {
                    var t = {}
                      , i = l.options.display || !!T.fn.dropdown.Constructor.Default && T.fn.dropdown.Constructor.Default.display;
                    l.Rs.bsContainer.addClass(e.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(G.DROPUP, e.hasClass(G.DROPUP)),
                    s = e.offset(),
                    r.is("body") ? n = {
                        top: 0,
                        left: 0
                    ...
                    l.Rs.bsContainer.css(t)
                }
                var s, n, o, l = this, r = T(this.options.container);
                this.Rs.button.on("click.bs.dropdown.data-api", function() {
                    l.isDisabled() || (e(l.Rs.newElement),
                    l.Rs.bsContainer.appendTo(l.options.container).toggleClass(G.SHOW, !l.Rs.button.hasClass(G.SHOW)).append(l.Rs.menu))
                }),
                T(window).off("resize" + F + "." + this.selectId + " scroll" + F + "." + this.selectId).on("resize" + F + "." + this.selectId + " scroll" + F + "." + this.selectId, function() {
                    l.Rs.newElement.hasClass(G.SHOW) && e(l.Rs.newElement)
                }),
                this.Rs.element.on("hide" + F, function() {
                    l.Rs.menu.data("height", l.Rs.menu.height()),
                    l.Rs.bsContainer.detach()
                })
            },
            ...
            setOptionStatus: function(e) {
                ...
                t.selectpicker.view.visibleElements && t.selectpicker.view.visibleElements.length) {
                    ...
                    this.options.source.data && this.Rs.element[0].appendChild(this.selectpicker.main.optionQueue)
                }
            },
            ...
            isDisabled: function() {
                return this.Rs.element[0].disabled
            },
            checkDisabled: function() {
                this.isDisabled() ? (this.Rs.newElement[0].classList.add(G.DISABLED),
                this.Rs.button.addClass(G.DISABLED).attr("aria-disabled", !0)) : this.Rs.button[0].classList.contains(G.DISABLED) && (this.Rs.newElement[0].classList.remove(G.DISABLED),
                this.Rs.button.removeClass(G.DISABLED).attr("aria-disabled", !1))
            },
            clickListener: function() {
                var O = this
                  , t = T(document);
                function e() {
                    O.options.liveSearch ? O.Rs.searchbox.trigger("focus") : O.Rs.menuInner.trigger("focus")
                }
                function i() {
                    O.dropdown && O.dropdown._popper && O.dropdown._popper.state ? e() : requestAnimationFrame(i)
                }
                t.data("spaceSelect", !1),
                this.Rs.button.on("keyup", function(e) {
                    /(32)/.test(e.keyCode.toString(10)) && t.data("spaceSelect") && (e.preventDefault(),
                    t.data("spaceSelect", !1))
                }),
                this.Rs.newElement.on("show.bs.dropdown", function() {
                    O.dropdown || "4" !== j.major || (O.dropdown = O.Rs.button.data("bs.dropdown"),
                    O.dropdown._menu = O.Rs.menu[0])
                }),
                this.Rs.button.on("click.bs.dropdown.data-api", function(e) {
                    if (O.options.allowClear) {
                        var t = e.target
                          , i = O.Rs.clearButton[0];
                        ...
                        function() {
                            if (O.multiple)
                                ...
                                e.selectedIndex = 0,
                                D = [i, !1, t],
                                O.Rs.element.triggerNative("change")
                            }
                            O.Rs.newElement.hasClass(G.SHOW) && (O.options.liveSearch && O.Rs.searchbox.trigger("focus"),
                            O.createView(!1))
                        }())
                    }
                    O.Rs.newElement.hasClass(G.SHOW) || O.setSize()
                }),
                this.Rs.element.on("shown" + F, function() {
                    O.Rs.menuInner[0].scrollTop !== O.selectpicker.view.scrollTop && (O.Rs.menuInner[0].scrollTop = O.selectpicker.view.scrollTop),
                    3 < j.major ? requestAnimationFrame(i) : e()
                }),
                this.Rs.menuInner.on("mouseenter", "li a", function(e) {
                ...
                this.Rs.menuInner.on("click", "li a", function(e, t) {
                    var i = T(this)
                      , s = O.Rs.element[0]
                    ...
                    !O.isDisabled() && !i.parent().hasClass(G.DISABLED)) {
                        ...
                        O.multiple) {
                                ...
                                if (g && w || b && I)
                                    if (g && 1 == g)
                                        ...
                                        var y = "string" == typeof O.options.maxOptionsText ? [O.options.maxOptionsText, O.options.maxOptionsText] : O.options.maxOptionsText
                                          , Rs. = "function" == typeof y ? y(g, b) : y
                                          , S = Rs.[0].replace("{n}", g)
                                          , E = Rs.[1].replace("{n}", b)
                                          , C = T('<div class="notify"></div>');
                                        Rs.[2] && (S = S.replace("{var}", Rs.[2][1 < g ? 0 : 1]),
                                        E = E.replace("{var}", Rs.[2][1 < b ? 0 : 1])),
                                        p.selected = !1,
                                        O.Rs.menu.append(C),
                                        g && w && (C.append(T("<div>" + S + "</div>")),
                                        h = !1,
                                        O.Rs.element.trigger("maxReached" + F)),
                                        b && I && (C.append(T("<div>" + E + "</div>")),
                                        h = !1,
                                        O.Rs.element.trigger("maxReachedGrp" + F)),
                                        setTimeout(function() {
                                            O.setSelected(l, !1)
                                        }, 10),
                            ...
                            d && O.setSelected(d, !1),
                            O.setSelected(o, !0);
                        O.options.source.data && O.Rs.element[0].appendChild(O.selectpicker.main.optionQueue),
                        !O.multiple || O.multiple && 1 === O.options.maxOptions ? O.Rs.button.trigger("focus") : O.options.liveSearch && O.Rs.searchbox.trigger("focus"),
                        h && (!O.multiple && a === s.selectedIndex || (D = [p.index, u.prop("selected"), r],
                        O.Rs.element.triggerNative("change")))
                    }
                }),
                this.Rs.menu.on("click", "li." + G.DISABLED + " a, ." + G.POPOVERHEADER + ", ." + G.POPOVERHEADER + " :not(.close)", function(e) {
                    e.currentTarget == this && (e.preventDefault(),
                    e.stopPropagation(),
                    O.options.liveSearch && !T(e.target).hasClass("close") ? O.Rs.searchbox.trigger("focus") : O.Rs.button.trigger("focus"))
                }),
                this.Rs.menuInner.on("click", ".divider, .dropdown-header", function(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
                    O.options.liveSearch ? O.Rs.searchbox.trigger("focus") : O.Rs.button.trigger("focus")
                }),
                this.Rs.menu.on("click", "." + G.POPOVERHEADER + " .close", function() {
                    O.Rs.button.trigger("click")
                }),
                this.Rs.searchbox.on("click", function(e) {
                    e.stopPropagation()
                }),
                this.Rs.menu.on("click", ".actions-btn", function(e) {
                    O.options.liveSearch ? O.Rs.searchbox.trigger("focus") : O.Rs.button.trigger("focus"),
                    e.preventDefault(),
                    e.stopPropagation(),
                    T(this).hasClass("bs-select-all") ? O.selectAll() : O.deselectAll()
                }),
                this.Rs.button.on("focus" + F, function(e) {
                    var t = O.Rs.element[0].getAttribute("tabindex");
                    void 0 !== t && e.originalEvent && e.originalEvent.isTrusted && (this.setAttribute("tabindex", t),
                    O.Rs.element[0].setAttribute("tabindex", -1),
                    O.selectpicker.view.tabindex = t)
                }).on("blur" + F, function(e) {
                    void 0 !== O.selectpicker.view.tabindex && e.originalEvent && e.originalEvent.isTrusted && (O.Rs.element[0].setAttribute("tabindex", O.selectpicker.view.tabindex),
                    this.setAttribute("tabindex", -1),
                    O.selectpicker.view.tabindex = void 0)
                }),
                this.Rs.element.on("change" + F, function() {
                    O.render(),
                    O.Rs.element.trigger("changed" + F, D),
                    D = null
                }).on("focus" + F, function() {
                    O.options.mobile || O.Rs.button[0].focus()
                })
            },
            liveSearchListener: function() {
                var u = this;
                this.Rs.button.on("click.bs.dropdown.data-api", function() {
                    u.Rs.searchbox.val() && (u.Rs.searchbox.val(""),
                    u.selectpicker.search.previousValue = void 0)
                }),
                this.Rs.searchbox.on("click.bs.dropdown.data-api focus.bs.dropdown.data-api touchend.bs.dropdown.data-api", function(e) {
                    e.stopPropagation()
                }),
                this.Rs.searchbox.on("input propertychange", function() {
                    var t = u.Rs.searchbox[0].value;
                    ...
                    t)
                        if (u.options.source.search)
                            ...
                            u.noScroll = !0,
                            u.Rs.menuInner.scrollTop(0),
                            u.selectpicker.search.elements = e,
                            u.createView(!0),
                            X.call(u, e, t)
                        }
                    else
                        u.selectpicker.search.previousValue && (u.Rs.menuInner.scrollTop(0),
                        u.createView(!1));
            ...
            val: function(t) {
                ...
                this.Rs.element.trigger("changed" + F, D),
                this.Rs.newElement.hasClass(G.SHOW))
                    if (this.multiple)
            ...
            changeAll: function(e) {
                if (this.multiple) {
                    ...
                    D = [null, null, n],
                    this.Rs.element.triggerNative("change"))
                }
            },
            selectAll: function() {
            ...
            toggle: function(e, t) {
                ...
                !1 === s && (i = this.Rs.newElement[0].classList.contains(G.SHOW),
                s = !0 === t && !1 === i || !1 === t && !0 === i),
                s && this.Rs.button.trigger("click.bs.dropdown.data-api")
            },
            open: function(e) {
                this.toggle(e, !0)
            },
            ...
            keydown: function(e) {
                var t, i, s, n, o, l = T(this), r = l.hasClass("dropdown-toggle"), a = (r ? l.closest(".dropdown") : l.closest(q.MENU)).data("this"), c = a.findLis(), d = !1, h = e.which === B && !r && !a.options.selectOnTab, p = Q.test(e.which) || h, u = a.Rs.menuInner[0].scrollTop, f = !0 === a.isVirtual() ? a.selectpicker.view.position0 : 0;
                if (!(112 <= e.which && e.which <= 123))
                    if (!(i = a.Rs.menu.hasClass(G.SHOW)) && (p || 48 <= e.which && e.which <= 57 || 96 <= e.which && e.which <= 105 || 65 <= e.which && e.which <= 90) && (a.Rs.button.trigger("click.bs.dropdown.data-api"),
                    a.options.liveSearch))
                        a.Rs.searchbox.trigger("focus");
                    else {
                        if (e.which === N && i && (e.preventDefault(),
                        a.Rs.button.trigger("click.bs.dropdown.data-api").trigger("focus")),
                        p) {
                            if (!c.length)
                                return;
                            ...
                            e.preventDefault();
                            var m = f + t;
                            e.which === M ? 0 === f && t === c.length - 1 ? (a.Rs.menuInner[0].scrollTop = a.Rs.menuInner[0].scrollHeight,
                            m = a.selectpicker.current.elements.length - 1) : d = (o = (n = a.selectpicker.current.data[m]).position - n.height) < u : e.which !== R && !h || (t === a.selectpicker.view.firstHighlightIndex ? (a.Rs.menuInner[0].scrollTop = 0,
                            ...
                            d && (a.Rs.menuInner[0].scrollTop = o),
                            a.options.liveSearch ? a.Rs.searchbox.trigger("focus") : l.trigger("focus")
                        ...
                        a.options.liveSearch && e.which === W || (a.Rs.menuInner.find(".active a").trigger("click", !0),
                        l.trigger("focus"),
            ...
            mobile: function() {
                ...
                this.Rs.element[0].classList.add("mobile-device")
            },
            refresh: function() {
                var e = this
                  , t = T.extend({}, this.options, h(this.Rs.element), this.Rs.element.data());
                this.options = t,
                ...
                this.setWidth(),
                this.setSize(!0),
                this.Rs.element.trigger("refreshed" + F)
            },
            hide: function() {
                this.Rs.newElement.hide()
            },
            show: function() {
                this.Rs.newElement.show()
            },
            remove: function() {
                this.Rs.newElement.remove(),
                this.Rs.element.remove()
            },
            destroy: function() {
                this.Rs.newElement.before(this.Rs.element).remove(),
                this.Rs.bsContainer ? this.Rs.bsContainer.remove() : this.Rs.menu.remove(),
                ...
                this.Rs.element.off(F).removeData("selectpicker").removeClass("bs-select-hidden selectpicker"),
